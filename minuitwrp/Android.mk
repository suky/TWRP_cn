...
ifeq ($(TW_TOUCH_VIBRATOR), true)
	LOCAL_CFLAGS += -DTW_TOUCH_VIBRATOR
endif
ifneq ($(TW_VIBRATOR_TIME_MS),)
  LOCAL_CFLAGS += -DTW_VIBRATOR_TIME_MS=$(TW_VIBRATOR_TIME_MS)
else
  LOCAL_CFLAGS += -DTW_VIBRATOR_TIME_MS=50
endif
